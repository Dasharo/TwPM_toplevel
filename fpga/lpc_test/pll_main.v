...
/* Module Version: 5.7 */
/* /home/akowalski/Downloads/diamond/3.13/ispfpga/bin/lin64/scuba -w -n pll_main -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 48 -fclkop 200.00 -fclkop_tol 0.5 -fclkos 100.00 -fclkos_tol 0.5 -phases 0 -phase_cntl STATIC -fb_mode 1 -fdc /home/akowalski/projekty/twpm/twpm_ecp5/TwPM_toplevel/fpga/lpc_test/build/cl/pll_main/pll_main.fdc  */
/* Thu Dec  7 17:48:48 2023 */


`timescale 1 ns / 1 ps
module pll_main (CLKI, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
